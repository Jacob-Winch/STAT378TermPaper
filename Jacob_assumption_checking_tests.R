...
bartlett.test(t, transformed_X1)
bartlett.test(t, transformed_X2)
bartlett.test(t, transformed_X3)
bartlett.test(t, transformed_X4)
bartlett.test(t, transformed_X5)
bartlett.test(t, transformed_X6)
bartlett.test(t, transformed_X7)
bartlett.test(t, transformed_X8)
bartlett.test(t, transformed_X9)
bartlett.test(t, transformed_X10)
bartlett.test(t, transformed_X11)
bartlett.test(t, transformed_X12)