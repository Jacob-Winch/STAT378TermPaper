...
library(qpcR) 
PRESS(model)
PRESS(transformed_model)
PRESS(full_transformed_model)
PRESS(final_transformed_model)

dffits(final_transformed_model)
dfbetas(final_transformed_model)
influence.measures(final_transformed_model) 


ols_plot_cooksd_bar(final_transformed_model)
ols_plot_cooksd_chart(final_transformed_model)
ols_plot_dfbetas(final_transformed_model)
ols_plot_dffits(final_transformed_model)

#influential points 1, 5, 11, 83, 85
